...
<table>
<tr>
<td>🪟 <b>毛玻璃风格</b><br/><sub>backdrop-filter + 半透明层叠 + 内发光</sub></td>
<td>🌓 <b>三段式主题</b><br/><sub>CSS 变量驱动 · 零闪烁切换</sub></td>
<td>🎭 <b>代码主题</b><br/><sub>亮暗双色语法高亮</sub></td>
<td>✨ <b>精细动画</b><br/><sub>卡片滑入 · 弹性曲线</sub></td>
</tr>
</table>
...
| 特性 | 实现 |
|:---:|:---|
| 🖥️ **四级断点** | 1024px（平板）/ 768px（手机）/ 375px（小屏）/ 横屏 |
...
│   ├── components/                  # Vue 组件
│   │   ├── TheGlobalElements.vue    # 全局元素
│   │   ├── TheMobileSidebar.vue     # 移动端侧边栏
│   │   ├── TheSidebarLeft.vue       # 左侧边栏
│   │   ├── TheSidebarRight.vue      # 右侧边栏
│   │   └── TheThemeSwitcher.vue     # 主题切换器
│   ├── layouts/                     # 布局模板
│   │   ├── default.vue              # 默认布局
│   │   └── admin.vue                # 管理后台布局
│   ├── pages/                       # 页面路由
