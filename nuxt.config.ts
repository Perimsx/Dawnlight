...
export default defineNuxtConfig({
  ...
  // 开发服务器绑定到 IPv4，避免仅监听 ::1 导致本机访问失败
  devServer: {
    host: '127.0.0.1',
    port: 3000
  },
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'Dawnlight 博客，记录与分享技术、实践与思考。' },
        ...
        { property: 'og:site_name', content: 'Dawnlight' },
      ...
      script: [
        // 清除旧 Service Worker，防止缓存拦截请求导致 MIME type 错误
        {
